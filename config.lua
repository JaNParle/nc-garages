...
Config.JobParkingSpots = {
    ['police'] = {
        vector4(442.39, -1012.16, 29.31, 358.48),
        vector4(446.03, -1012.37, 29.31, 357.44),
        vector4(449.65, -1012.58, 29.31, 357.76),
        vector4(453.2, -1012.78, 29.31, 358.27),
        vector4(456.83, -1012.64, 29.31, 353.03),
        vector4(460.43, -1012.78, 29.31, 357.73)
    }
}
...
Config.JobGarages = {
    ['police'] = {
        label = 'Police Garage',
        coords = vector4(438.92, -1009.82, 29.46, 309.83),
        type = 'job',
        job = 'police',
        spawnPoint = vector4(442.45, -1009.68, 29.31, 357.82),
        -- Transfer animation points
        transferSpawn = vector4(401.44, -1092.4, 29.38, 357.96),
        transferArrival = vector4(408.24, -998.7, 29.27, 39.06),
        transferExit = vector4(406.23, -948.21, 29.41, 358.12),
        vehicles = {
            ['polcoquette'] = {
                label = 'Police Coquette',
                model = 'polcoquette',
                icon = '🚓'
            },
            ['polpenumbra'] = {
                label = 'Police Penumbra',
                model = 'polpenumbra',
                icon = '🚓'
            },
            ['polbuffalo4'] = {
            ...
            ['pbus'] = {
                label = 'Autobuz Penitenciar',
                model = 'pbus',
                icon = '🚓'
            },
            ['riot'] = {
                label = 'Blindata Politie',
                model = 'riot',
                icon = '🚓'
            }
        }
