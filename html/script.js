...
function getMetricStateClass(value) {
    const safeValue = clampPercent(value);
    if (safeValue <= 30) return 'is-critical';
    if (safeValue <= 60) return 'is-warning';
    return 'is-good';
}
...
function openGarage(data) {
    ...
    updateVehicleCount(currentVehicles.length);
    ...
    card.innerHTML = `
        ...
        <div class="vehicle-info">
            ...
            <div class="status-bars">
                <div class="status-item metric-row">
                    <div class="status-label">
                        <span>${getMetricLabel('fuel')}</span>
                        <span class="status-value is-good">100%</span>
                    </div>
                    <div class="progress-bar metric-track is-good">
                        <div class="progress-fill fuel is-good" style="width: 100%"></div>
                    </div>
                </div>
                <div class="status-item metric-row">
                    <div class="status-label">
                        <span>${getMetricLabel('engine')}</span>
                        <span class="status-value is-good">100%</span>
                    </div>
                    <div class="progress-bar metric-track is-good">
                        <div class="progress-fill engine is-good" style="width: 100%"></div>
                    </div>
                </div>
                <div class="status-item metric-row">
                    <div class="status-label">
                        <span>${getMetricLabel('body')}</span>
                        <span class="status-value is-good">100%</span>
                    </div>
                    <div class="progress-bar metric-track is-good">
                        <div class="progress-fill body is-good" style="width: 100%"></div>
                    </div>
                </div>
            </div>
...
function renderVehicles() {    
    ...
    updateVehicleCount(visibleVehicles);
...
function createVehicleCard(vehicle) {
    ...
    const fuelValue = clampPercent(vehicle.fuel || 0);
    const engineValue = clampPercent(vehicle.engine || 0);
    const bodyValue = clampPercent(vehicle.body || 0);
    const fuelStateClass = getMetricStateClass(fuelValue);
    const engineStateClass = getMetricStateClass(engineValue);
    const bodyStateClass = getMetricStateClass(bodyValue);
        ...
        <div class="vehicle-info">
            ...
            <div class="status-bars">
                <div class="status-item metric-row">
                    <div class="status-label">
                        <span>${getMetricLabel('fuel')}</span>
                        <span class="status-value ${fuelStateClass}">${fuelValue}%</span>
                    </div>
                    <div class="progress-bar metric-track ${fuelStateClass}">
                        <div class="progress-fill fuel ${fuelStateClass}" style="width: ${fuelValue}%"></div>
                    </div>
                </div>
                <div class="status-item metric-row">
                    <div class="status-label">
                        <span>${getMetricLabel('engine')}</span>
                        <span class="status-value ${engineStateClass}">${engineValue}%</span>
                    </div>
                    <div class="progress-bar metric-track ${engineStateClass}">
                        <div class="progress-fill engine ${engineStateClass}" style="width: ${engineValue}%"></div>
                    </div>
                </div>
                <div class="status-item metric-row">
                    <div class="status-label">
                        <span>${getMetricLabel('body')}</span>
                        <span class="status-value ${bodyStateClass}">${bodyValue}%</span>
                    </div>
                    <div class="progress-bar metric-track ${bodyStateClass}">
                        <div class="progress-fill body ${bodyStateClass}" style="width: ${bodyValue}%"></div>
                    </div>
                </div>
            </div>
...
function updateVehicleDetailView() {
    ...
    const fuelValue = clampPercent(selectedVehicle.fuel || 0);
    const engineValue = clampPercent(selectedVehicle.engine || 0);
    const bodyValue = clampPercent(selectedVehicle.body || 0);
